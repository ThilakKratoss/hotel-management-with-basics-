...
const  descriptionP = document.querySelector('h1.description');
...
toggleList.addEventListener('click', () =>
{
    ...
    {   
        toggleList.textContent = 'HIDE YOUR ORDER';
        listDiv.style.display = 'block' ;
    }else{
        toggleList.textContent  = 'SHOW YOUR ORDER'; 
...
addItemButton.addEventListener('click',()=>
{
    ...
    ul.appendChild(li)/r/n;
    addItemInput.value = ""/r/n;
});
